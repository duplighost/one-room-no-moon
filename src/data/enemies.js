...
export const ENEMY_TYPES = {
  skitter:  { display: 'Pewling',     cost: 1, hp: 2.2, speed: 92, r: 14, color: '#ff7b72', score: 60,  from: 1 },
  gunner:   { display: 'Censer',      cost: 2, hp: 3.6, speed: 76, r: 16, color: '#ffba73', score: 100, from: 1 },
  charger:  { display: 'Ramwraith',   cost: 2, hp: 4.4, speed: 90, r: 18, color: '#ff5c91', score: 110, from: 2 },
  turret:   { display: 'Lectern',     cost: 2, hp: 4.9, speed: 26, r: 18, color: '#c494ff', score: 120, from: 3 },
  brute:    { display: 'Ox-Warden',   cost: 3, hp: 8.1, speed: 62, r: 24, color: '#ffa06a', score: 170, from: 4 },
  sniper:   { display: 'Long Candle', cost: 3, hp: 4.8, speed: 84, r: 17, color: '#9cd7ff', score: 140, from: 6 },
  hexer:    { display: 'Antiphon',    cost: 3, hp: 5.4, speed: 84, r: 18, color: '#a8ffd8', score: 150, from: 8 },
  myrmidon: { display: 'Crown-Sworn', cost: 4, hp: 7.4, speed: 88, r: 21, color: '#ffd39a', score: 170, from: 10 },
};
